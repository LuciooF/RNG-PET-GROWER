...
DeveloperProductConfig.PRODUCTS = {
    ...
    [41] = {
        id = 3324962959,
        name = "PetSlotExpansion",
        displayName = "🐾 Pet Slot Expansion",
        description = "Permanently add 1 more pet slot to your collection!",
        type = DeveloperProductConfig.TYPES.SPECIAL,
        price = 199,
        icon = "rbxassetid://3324962959",
        special = {
            action = "pet_slot_expansion",
            value = 1
        }
    },
}
